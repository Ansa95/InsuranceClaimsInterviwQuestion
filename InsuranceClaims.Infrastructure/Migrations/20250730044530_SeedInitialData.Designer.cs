...
namespace InsuranceClaims.Infrastructure.Migrations
{
    ...
    [Migration("20250730044530_SeedInitialData")]
            ...
            modelBuilder.Entity("InsuranceClaims.Domain.Entities.Claim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 500m,
                            ClaimAmount = 500m,
                            CreatedDate = new DateTime(2025, 7, 30, 4, 45, 30, 7, DateTimeKind.Utc).AddTicks(3732),
                            Description = "Hospitalization due to accident",
                            PolicyId = 1,
                            PolicyholderId = 1,
                            Status = 0,
                            SubmittedByUserId = 1,
                            SubmittedOn = new DateTime(2025, 7, 30, 4, 45, 30, 7, DateTimeKind.Utc).AddTicks(3468)
                        });
                });
            ...
            modelBuilder.Entity("InsuranceClaims.Domain.Entities.Policy", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2026, 7, 30, 4, 45, 30, 7, DateTimeKind.Utc).AddTicks(1568),
                            PolicyName = "Health Policy A",
                            PolicyNumber = "P123456",
                            PremiumAmount = 1000m,
                            StartDate = new DateTime(2025, 7, 30, 4, 45, 30, 7, DateTimeKind.Utc).AddTicks(1266)
                        });
                });
